...
pl.DataFrame(
    [
        ...
        {"stage": "4. Scoring", "input": "Feature table", "output": "Rule, statistical, ML, dollar, and hybrid scores", "implementation_status": "Implemented for synthetic data"},
        {"stage": "5. Review queue export", "input": "Ranked records", "output": "Analyst queue with explanations", "implementation_status": "CSV export implemented"},
...
pl.DataFrame(
    [
        ...
        {"layer": "Scoring service or batch job", "responsibility": "Rule, statistical, ML, dollar, and hybrid ranking", "control": "Versioned configuration and threshold approval"},
