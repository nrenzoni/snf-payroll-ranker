...
- [x] 1.4 Add residual-specific diagnostic helpers needed for hard-rule funnel tables, issue-type diagnostics, top-K overlap views, severe-miss examples, and plot-ready notebook outputs.
