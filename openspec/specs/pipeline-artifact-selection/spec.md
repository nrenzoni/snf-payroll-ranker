# pipeline-artifact-selection Specification

## Purpose
Define selective pipeline artifact generation and explicit access behavior for artifacts omitted from a pipeline run.
