...
class MetricCol(StrEnum):
    ...
    F1_AT_K = "f1_at_k"
    RESIDUAL_NDCG_AT_K = "residual_ndcg_at_k"
    RULE_MISSED_SEVERE_RECALL_AT_K = "rule_missed_severe_recall_at_k"
    REVIEWER_YIELD_AT_K = "reviewer_yield_at_k"
    INCREMENTAL_UTILITY_AT_K = "incremental_utility_at_k"
