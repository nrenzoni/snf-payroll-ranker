...
#  blocks. See https://pygments.org/docs/lexers/#available-lexers for available
#  options.
#  See also: HTMLExporter.lexer_options
# c.QtExporter.lexer_options = {}
...
#  options.
#  See also: HTMLExporter.lexer_options
# c.SlidesExporter.lexer_options = {}
...
#  Default: ''
# c.SlidesExporter.reveal_number = ''
...
#
#  These arguments will be passed directly to the browser launch method and can
#  be used to customize browser behavior beyond the default settings.
#  Default: []
# c.WebPDFExporter.browser_args = []
...
#  options.
#  See also: HTMLExporter.lexer_options
# c.WebPDFExporter.lexer_options = {}
...
#  Increase this value if your notebook has a lot of complex JavaScript output
#  that needs more time to load.
#  Default: 100
# c.WebPDFExporter.page_render_timeout = 100
...
#
#  Populates the ``latex`` key in the resources dict, adding definitions for
#  pygments highlight styles.
#
#  Sets the authors, date and title of the latex document, overriding the values
